    ...
    <div className="bg-white p-8 rounded-lg shadow border max-w-2xl mx-auto text-gray-800 print:shadow-none print:border-none">
      ...
      <div className="space-y-6">
        ...
        <section className="grid grid-cols-1 gap-2">
          ...
          <p>
            <strong>Invocation:</strong> {meeting.openingPrayer}
          </p>
        </section>
        ...
        <section className="grid grid-cols-1 gap-2 border-t pt-4">
          ...
          <p>
            <strong>Benediction:</strong> {meeting.closingPrayer}
          </p>
        </section>
      </div>
      ...
      <button
        ...
        className="mt-8 bg-blue-600 text-white px-4 py-2 rounded print:hidden w-full"
      >
        Print Program
      </button>
    </div>
